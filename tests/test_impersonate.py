...
class TestImpersonation:
    ...
    CURL_BINARIES_AND_SIGNATURES = [
        ...
        ("curl_chrome99_windows", None, None, "chrome_99.0.4844.51_win10"),
        ("curl_chrome100_windows", None, None, "chrome_100.0.4896.127_win10"),
        ("curl_chrome101_windows", None, None, "chrome_101.0.4951.67_win10"),
        ("curl_chrome104_windows", None, None, "chrome_104.0.5112.81_win10"),
        ("curl_chrome107_windows", None, None, "chrome_107.0.5304.107_win10"),
        ("curl_chrome110_windows", None, None, "chrome_110.0.5481.177_win10"),
        ("curl_chrome116_windows", None, None, "chrome_116.0.5845.180_win10"),
        ("curl_chrome99_android", None, None, "chrome_99.0.4844.73_android12-pixel6"),
        ("curl_edge99_windows", None, None, "edge_99.0.1150.30_win10"),
        ("curl_edge101_windows", None, None, "edge_101.0.1210.47_win10"),
